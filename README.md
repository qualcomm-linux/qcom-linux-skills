...
| [qcom-yocto-new-machine](skills/qcom-yocto-new-machine/SKILL.md) | developers | Bring up a new board in meta-qcom or meta-qcom-3rdparty: machine .conf, SoC include, CI yml, and board-specific recipes |
